<template>
    <input type="text" name="" id="" v-model="wsurl" style="width: 90%;">
    <input type="button" value="连接" @click="remote">
    <div id="display"></div>
</template>

<script>
import Guacamole from '../../utils/all.min.js';
    ...
    methods: {
        remote() {
            ...
            var guac = new Guacamole.Client(
                ...
                new Guacamole.WebSocketTunnel(`${this.wsurl}?height=${display.clientHeight}&width=${display.clientWidth}&`)
